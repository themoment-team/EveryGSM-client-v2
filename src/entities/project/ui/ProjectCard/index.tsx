...
const ProjectCard = ({ project, onDetailClick, LikeButton }: ProjectCardProps) => {
  const { imageSrc, projectName, teamName, description, tags, deployLink } = project;

  const [isCenterHover, setIsCenterHover] = useState(false);

  return (
    <div className="relative h-82.25 w-70 rounded-xl border border-[#2F2F2F] bg-[#22222280] p-6 backdrop-blur-lg">
      <div
