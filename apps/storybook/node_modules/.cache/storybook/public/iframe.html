    ...
    console.warn('unable to connect to top frame for connecting dev tools');
      ...
      #storybook-docs[hidden] {
        display: none !important;
            ...
            window['STORIES'] = [{"titlePrefix":"","directory":"./node_modules/ui","files":"**!(node_modules)/*.stories.@(js|jsx|ts|tsx)","importPathMatcher":"^\\.[\\\\/](?:node_modules\\/ui\\/(?!\\.)[^/]*?(?:(?!(?:node_modules))[^/]*?)\\/(?!\\.)(?=.)[^/]*?\\.stories\\.(js|jsx|ts|tsx))$"}];
      ...
      import './vendors-node_modules_pnpm_babel_runtime_7_21_0_node_modules_babel_runtime_helpers_esm_asyncTo-4d7658.iframe.bundle.js';
